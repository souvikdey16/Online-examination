  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/.jpg" width=100 height=100 alt="" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Souvik Dey</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8100536941</h4>
		<h4 style="font-family:'typo' ">dey.souvik163@gmail.com</h4>
		<h4 style="font-family:'typo' ">Modern Insitute of Engineering & Technology ,Bandel</h4></div></div>
		</p>
      </div>
